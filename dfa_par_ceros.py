...
class DFAGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Simulador de DFA - Cantidad Par de Ceros")
        ...
        self.transition_table = ttk.Treeview(root, columns=("state", "symbol", "new_state"), show="headings", height=5)
    ...
    def start_simulation(self):
        ...
        self.dfa = DFA(self.transitions, "q0", {"q0"})
